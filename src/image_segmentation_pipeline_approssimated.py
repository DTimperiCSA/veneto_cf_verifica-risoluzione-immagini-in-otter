...
TMP_SEGMENTATION_BBOX_MINUS_PERCENT_DIR.mkdir(parents=True, exist_ok=True)
TMP_SEGMENTATION_BBOX_MINUS_PERCENT_DIR.mkdir(parents=True, exist_ok=True)
TMP_SEGMENTATION_ROT_BBOX_MINUS_PERCENT_DIR.mkdir(parents=True, exist_ok=True)
...
def analyze_chromatic_band_approximated(candidate: Path, unet_model, logger):
    try:
        # --- predizione mask ---
        ...
        # --- salva mask ---
        TMP_SEGMENTATION_BBOX_MINUS_PERCENT_DIR.mkdir(parents=True, exist_ok=True)
        mask_out_path = TMP_SEGMENTATION_BBOX_MINUS_PERCENT_DIR / f"{candidate.parent.name}_{candidate.stem}_mask.png"
        ...
        bbox_out_path = TMP_SEGMENTATION_BBOX_MINUS_PERCENT_DIR / f"{candidate.parent.name}_{candidate.stem}_bbox.png"
        ...
        rect_out_path = TMP_SEGMENTATION_BBOX_MINUS_PERCENT_DIR / f"{candidate.parent.name}_{candidate.stem}.png"
...
def analyze_chromatic_band_keypoint_approximated(candidate: Path, logger):
    """
