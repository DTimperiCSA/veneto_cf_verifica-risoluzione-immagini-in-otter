...
def find_output_dir() -> tuple[Path, Path]:
    ...
    super_res_dir = os.path.join(SUPER_RES_DIR, f"super_res{final_suffix}")
    downscaling_dir = os.path.join(DOWNSCALE_DIR, f"downscale{final_suffix}")
